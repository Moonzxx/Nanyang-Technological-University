...
class BottomLiquidBar extends StatefulWidget {
  const BottomLiquidBar({Key? key, required this.screen, required this.barItemNo}) : super(key: key);
  final List<Widget> screen;
  final int barItemNo;

  @override
  _BottomLiquidBarState createState() => _BottomLiquidBarState();
}

class _BottomLiquidBarState extends State<BottomLiquidBar> with TickerProviderStateMixin{
...
/*
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    switch(widget.barItemNo){
      case 3:
        BLW = [bottomLiquidWidget(0), bottomLiquidWidget(1), bottomLiquidWidget(2)];
        BGCW = [bGCircleWidget(0),bGCircleWidget(1),bGCircleWidget(2)];
        TBI = [tBIcons(0),tBIcons(1),tBIcons(2)];
        TBT = [tBTrigger(0),tBTrigger(1),tBTrigger(2)];
        break;
      case 5:
        BLW = [bottomLiquidWidget(0), bottomLiquidWidget(1), bottomLiquidWidget(2),bottomLiquidWidget(3),bottomLiquidWidget(4)];
        BGCW = [bGCircleWidget(0),bGCircleWidget(1),bGCircleWidget(2),bGCircleWidget(3),bGCircleWidget(4)];
        TBI = [tBIcons(0),tBIcons(1),tBIcons(2),tBIcons(3),tBIcons(4)];
        TBT = [tBTrigger(0),tBTrigger(1),tBTrigger(2),tBTrigger(3),tBTrigger(4)];
        break;
